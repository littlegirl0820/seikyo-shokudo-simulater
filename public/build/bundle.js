    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(strong, file$2, 71, 8, 1995);
    			attr_dev(h3, "class", "svelte-bqys7a");
    			add_location(h3, file$2, 70, 4, 1982);
    			add_location(button, file$2, 76, 4, 2154);
