    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = space();
    			hr3 = element("hr");
    			add_location(hr0, file, 989, 1, 13511);
    			add_location(hr1, file, 991, 1, 13561);
    			add_location(hr2, file, 993, 1, 13607);
    			add_location(hr3, file, 995, 1, 13650);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = space();
    			hr3 = element("hr");
    			add_location(hr0, file, 981, 1, 13344);
    			add_location(hr1, file, 983, 1, 13393);
    			add_location(hr2, file, 985, 1, 13438);
    			add_location(hr3, file, 987, 1, 13480);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, hr0, anchor);
    			insert_dev(target, t0, anchor);
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = space();
    			hr3 = element("hr");
    			add_location(hr0, file, 973, 1, 13177);
    			add_location(hr1, file, 975, 1, 13226);
    			add_location(hr2, file, 977, 1, 13271);
    			add_location(hr3, file, 979, 1, 13313);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, hr0, anchor);
    			insert_dev(target, t0, anchor);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = space();
    			hr3 = element("hr");
    			add_location(hr0, file, 965, 1, 13004);
    			add_location(hr1, file, 967, 1, 13055);
    			add_location(hr2, file, 969, 1, 13102);
    			add_location(hr3, file, 971, 1, 13146);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, hr0, anchor);
    			insert_dev(target, t0, anchor);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			h30 = element("h3");
    			h30.textContent = "最終更新 2023/01/27";
    			t3 = space();
    			h31 = element("h3");
    			...
    			if (if_block) if_block.c();
    			if_block_anchor = empty();
    			add_location(h1, file, 951, 0, 12582);
    			add_location(h30, file, 952, 0, 12605);
    			attr_dev(a, "href", "https://west2-univ.jp/sp/osaka-univ.php");
    			attr_dev(a, "target", "_blank");
    			attr_dev(a, "rel", "noreferrer");
    			add_location(a, file, 954, 21, 12656);
    			add_location(h31, file, 953, 0, 12630);
    			add_location(button0, file, 960, 0, 12771);
    			add_location(button1, file, 961, 0, 12822);
    			add_location(button2, file, 962, 0, 12874);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
